		...
		*/
		...
		Pass
		{
			...
			float4 frag(v2f i) : COLOR
			{
				...
				//return float4(_StarColor[0] * step(0, i.position_in_world_space.y), _StarColor[1] * step(0, i.position_in_world_space.y), _StarColor[2] * step(0, i.position_in_world_space.y), 0);
				return _StarColor + float4(offset, offset, offset, 0);
			}
